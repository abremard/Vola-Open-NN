...
# Date Range
lowerBound = datetime.date.today() - datetime.timedelta(days = 10)
upperBound = datetime.date.today()
...
for stock in stockNames:
    ...
    for fname in glob.glob(path):
        ...
        if datetime.datetime.strptime(currentDay, '%Y-%m-%d').date() <= lowerBound:
            continue
        print(currentDay)
        ...
        fig.write_html("../Data/Output/WL/HTML/" + stock + "-" + currentDay + ".html", auto_open=False)
